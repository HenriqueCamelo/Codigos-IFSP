...
<!-- 		<h2>Autenticação</h2> -->
	    ...
	    <br><button id="btnLogin" style="margin-left:25%" type="button" class="btn btn-success w-50 ">Entrar</button>
	    <br><a id="linkCadUser" style="margin-left:25%" type="button" class="btn btn-warning w-50 " href="#">Cadastrar Usuário </a>
	    <br><a id="linkLembrarSenha" style="margin-left:40%" href="#">LembrarSenha </a>
	  </form>
	</div>

	<div  id="frmLembrarSenhaArea" class="container mt-2">
		<h2>Lembrar Senha</h2>
		<form action="/action_page.php">
			<div class="mb-3 mt-3">
		      <label for="email">Email:</label>
	    	...
	    	<button id="btnLembrarSenha" type="button" class="btn btn-success">Enviar</button>
	...
	<div  id="frmCadUserArea" class="container mt-3">
		...
		<form action="/action_page.php">
	    	...
	    	<button id="btnLembrarSenha"  class="btn btn-success">Save</button>
	    	<button id="btnCancelaCad"  class="btn btn-danger ">Cancelar</button>
	  </form>
	</div>
