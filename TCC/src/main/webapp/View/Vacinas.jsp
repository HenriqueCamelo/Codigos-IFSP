...
<body>
		...
		<div class="container ">
			<div class="container p-4 bg-light mt-3 border rounded-4">	
				...
				<br><a id="linkCadUser"  class=" my-2 w-50 " style="margin-left:3%" href="CadastrarVacina.jsp">Cadastrar Vacina</a>
				<div  id="vacinasArea" class="container mx-auto ">
					<form action="/TCC/ServeltAnimal?acao=vacina" method="post">
						...
						<div class="mb-3 mt-3">
					      ...
					      <input type="text" class="form-control" id="idAn" placeholder="Insira o Id" name="idAn">
					    </div>
					    
					    <div class="mb-3">
					      <label for="pwd">Data:</label>
					      <input type="date" class="form-control" id="dataVac" placeholder="Enter password" name="dataVac">
					    </div>
					    
					    <div class="mb-3">
					      <label for="pwd">Vacinas:</label>
					      <input type="text" class="form-control" id="vacina" placeholder="Insira vacina" name="vacina">
					    </div>
