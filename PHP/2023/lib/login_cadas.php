...
<body>
    ...
    <!--Formulário para pesquisa-->
            ...
            Nome:
            <input type="text" name="txtNome" id="loginNome" value = "<?php if(isset($campo_form['txtNome'])) echo $campo_form['txtNome']?>" placeholder="Digite o Nome">
            <br><br>
            </div>
...
if(!empty($campos_form['btnPesquisar']))
{
    ...
    $sql = "SELECT * FROM tb_cadas WHERE cadNome LIKE :nome AND cadSenha like :senha";
