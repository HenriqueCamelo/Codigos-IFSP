...
$consulta = $conexao->prepare('SELECT * FROM tabalugar where carProId = :code');
...
<body>
    ...
    <form action="alterar_alu_action.php" method = "post">
         ...
         <a href="alugar.php?codigo=" class="btn">Carrinho de alugar</a>
